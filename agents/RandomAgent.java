...
/**
 * Agente que juega de forma aleatoria
 */
public class RandomAgent extends Agent {

    private State state;
    private AID mainAgent;
    private int myId, opponentId, opponentId0, opponentId1, opponentId2, opponentId3, opponentId4;
    private int N, E, R, P, S=4;
    private float I;
                ...
                switch (state) {
                        ...
                        if (msg.getPerformative() == ACLMessage.INFORM) {
                            if (msg.getContent().startsWith("Id#")) { //Game settings updated
                                ...
                                try {
                                    ...
                                    //System.out.println("Entro en s1Awaiting--------------------------"+gameStarted);
                                } catch (NumberFormatException e) {
                                    System.out.println(getAID().getName() + ":" + state.name() + " - Bad message");
                                }
                    ...
                    case s2Round:
                        ...
                        if (msg.getPerformative() == ACLMessage.REQUEST /*&& msg.getContent().startsWith("Position")*/) {
                            ...
                            msg.setContent("Action#" + random.nextInt(S));
